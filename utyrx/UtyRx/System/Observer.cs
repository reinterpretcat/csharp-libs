...
namespace UtyRx
{
    public static class Observer
    {
        ...
        {
            return Create<T>(onNext, UtyRx.Stubs.Throw, UtyRx.Stubs.Nop);
        }

        public static IObserver<T> Create<T>(Action<T> onNext, Action<Exception> onError)
        {
            return Create<T>(onNext, onError, UtyRx.Stubs.Nop);
        }

        public static IObserver<T> Create<T>(Action<T> onNext, Action onCompleted)
        {
            return Create<T>(onNext, UtyRx.Stubs.Throw, onCompleted);
        }
        ...
        class AutoDetachObserver<T> : UtyRx.Operators.OperatorObserverBase<T, T>
        {
    ...
    public static partial class ObserverExtensions
    {
        ...
        {
            return new UtyRx.Operators.SynchronizedObserver<T>(observer, new object());
        }

        public static IObserver<T> Synchronize<T>(this IObserver<T> observer, object gate)
        {
            return new UtyRx.Operators.SynchronizedObserver<T>(observer, gate);
        }
    }
    ...
    public static partial class ObservableExtensions
    {
        ...
        {
            return source.Subscribe(UtyRx.InternalUtil.ThrowObserver<T>.Instance);
        }
