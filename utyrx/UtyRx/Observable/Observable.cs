...
namespace UtyRx
{
    ...
    public static partial class Observable
    {
        ...
        {
            // optimized path
            var whereObservable = source as UtyRx.Operators.WhereObservable<T>;
        ...
        {
            return new DistinctObservable<TSource>(source, EqualityComparer<TSource>.Default);
        }
        ...
        {
            return new DistinctObservable<TSource, TKey>(source, keySelector, EqualityComparer<TKey>.Default);
        }
        ...
        {
            return new DistinctUntilChangedObservable<T, TKey>(source, keySelector, EqualityComparer<TKey>.Default);
        }
