...
namespace UtyRx
{
    ...
    public static partial class Observable
    {
        ...
        public static IObservable<UtyRx.TimeInterval<TSource>> TimeInterval<TSource>(this IObservable<TSource> source)
        {
            return TimeInterval(source, Scheduler.DefaultSchedulers.TimeBasedOperations);
        }

        public static IObservable<UtyRx.TimeInterval<TSource>> TimeInterval<TSource>(this IObservable<TSource> source, IScheduler scheduler)
        {
            return new UtyRx.Operators.TimeIntervalObservable<TSource>(source, scheduler);
        }
